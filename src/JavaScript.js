        ...
        <div className="col-12 col-md-6 col-lg-3">
          <div className="card course-card">
            ...
            >
              <div className="shapes">
                <svg
                  class="javascript-card2-shape1 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                ...
                <svg
                  class="javascript-card2-shape2 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                ...
                <svg
                  class="javascript-card2-shape3 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                ...
                <svg
                  class="javascript-card2-shape4 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
              ...
              <div className="row">
                <div className="col-auto">
                  ...
                  <p
                    ...
                    className="card-text text-left"
                  >
                    with <strong>Reed Barger</strong>
                  </p>
                </div>
                <div className="col-auto ml-auto">
                  <img
                    src="https://scrimba.com/avatars/reedbarger/64"
                    className="img-fluid avatar rounded-circle"
                  />
                </div>
              </div>
        ...
        <div className="col-12 col-md-6 col-lg-3">
          <div className="card course-card">
            ...
            >
              <div className="shapes">
                <svg
                  class="javascript-card4-shape1 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                >
                  <path
                    ...
                    d="M9.29261 5.23311C21.8211 -4.9955 35.5207 12.0092 49.7636 15.442C60.6519 18.0663 73.5169 14.3472 80.9487 22.5036C91.3853 33.9578 103.182 50.0749 95.5757 65.7208C88.0075 81.288 67.0064 78.5017 51.1777 83.7402C35.8226 88.8219 18.4865 104.422 6.87518 95.0759C-4.6975 85.7611 7.90853 65.3205 8.34065 49.2608C8.75633 33.8123 -3.15401 15.3948 9.29261 5.23311Z"
                  ></path>
                </svg>
                <svg
                  class="javascript-card4-shape2 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
              ...
              <div className="row">
                <div className="col-auto">
                  ...
                  <p
                    ...
                    className="card-text text-left"
                  >
                    with <strong>Ania Kubow</strong>
                  </p>
                </div>
                <div className="col-auto ml-auto">
                  <img
                    src="https://scrimba.com/avatars/uid/uN32gmcm/64"
                    className="img-fluid avatar rounded-circle"
                  />
                </div>
              </div>
