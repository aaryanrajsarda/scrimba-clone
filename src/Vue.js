          ...
          <div className="card course-card">
            ...
            >
              <div className="shapes">
                <svg
                  class="vue-card1-shape1 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                ...
                >
                  <path
                    style={{ fill: "hsla(140.00,27.00%,96.00%,100%)" }}
                ...
                <svg
                  class="vue-card1-shape2 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                >
                  <path
                    style={{ fill: "hsla(139.00,25.50%,92.50%,100%)" }}
                    d="M46.6443 2.02753C66.6399 1.53324 88.5794 7.59278 95.422 28.5087C102.874 51.2865 93.5364 76.7516 75.5776 90.4677C58.9651 103.156 37.2191 98.7293 21.1053 85.2685C5.82684 72.5056 -2.06419 50.8861 4.10887 30.7659C10.0345 11.4522 28.3111 2.48073 46.6443 2.02753Z"
                  ></path>
                </svg>
              </div>
              <h2 className="text-right course-name">The Vue Bootcamp</h2>
            </div>
              ...
              <div className="row">
                <div className="col-auto">
                  ...
                  <p
                    ...
                    className="card-text text-left"
                  >
                    with <strong>Victor Gonzalez</strong>
                  </p>
                </div>
                <div className="col-auto ml-auto">
                  <img
                    src="https://scrimba.com/avatars/uid/u9Ld9du5/64"
        ...
        <div className="col-12 col-md-6 col-lg-3">
          <div className="card course-card">
            ...
            >
              <div className="shapes">
                <svg
                  class="vue-card2-shape1 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                >
                  <path
                    style={{
                      fill: "hsla(252.00,100.00%,86.00%,100%)",
                    }}
                ...
                <svg
                  class="vue-card2-shape2 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                ...
                <svg
                  class="vue-card2-shape3 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
              ...
              <h2 className="text-right course-name">Learn Vuetify for Free</h2>
            </div>
            <div className="card-body p-2">
              <div className="row">
                <div className="col-auto">
                  ...
                  <p
                    ...
                    className="card-text text-left"
                  >
                    with <strong>Gwen Faraday</strong>
                  </p>
                </div>
                <div className="col-auto ml-auto">
                  <img
                    src="https://scrimba.com/avatars/uid/uKQ9rWhD/64"
                    className="img-fluid avatar rounded-circle"
                  />
                </div>
              </div>
        ...
        <div className="col-12 col-md-6 col-lg-3">
          <div className="card course-card">
            ...
            >
              <div className="shapes">
                <svg
                  class="vue-card3-shape1 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                ...
                <svg
                  class="vue-card3-shape2 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
              ...
              <h2 className="text-right course-name">Learn Vue.js for Free</h2>
            </div>
            <div className="card-body p-2">
              <div className="row">
                <div className="col-auto">
                  ...
                  <p
                    ...
                    className="card-text text-left"
                  >
                    with <strong>Zaydek Gualtieri</strong>
                  </p>
                </div>
                <div className="col-auto ml-auto">
                  <img
                    src="https://scrimba.com/avatars/zaydek/64"
                    className="img-fluid avatar rounded-circle"
                  />
                </div>
              </div>
        ...
        <div className="col-12 col-md-6 col-lg-3">
          <div className="card course-card">
            ...
            >
              <div className="shapes">
                <svg
                  class="vue-card4-shape1 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                ...
                <svg
                  class="vue-card4-shape2 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                ...
                <svg
                  class="vue-card4-shape3 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
                ...
                <svg
                  class="vue-card4-shape4 img-fluid"
                  width="100"
                  viewBox="0 0 100 100"
                  preserveAspectRatio="none"
                  height="100"
              ...
              <h2 className="text-right course-name">Learn Vuex</h2>
            </div>
            <div className="card-body p-2">
              <div className="row">
                <div className="col-auto">
                  ...
                  <p
                    ...
                    className="card-text text-left"
                  >
                    with <strong>Connor Lindsey</strong>
                  </p>
                </div>
                <div className="col-auto ml-auto">
                  <img
                    src="https://scrimba.com/avatars/connorlindsey/64"
                    className="img-fluid avatar rounded-circle"
                  />
                </div>
              </div>
